                ...
                children: [
                  ...
                  _outputs != null
                      ? Column(
                        children: <Widget>[
                          Text(
                              _outputs[0]["label"]=='0 mask'?"ใส่หน้ากาก":"ไม่ใส่หน้ากาก",
                              style: TextStyle(
                                color: _outputs[0]["label"]=='0 mask'?Colors.green:Colors.deepOrangeAccent,
                                fontSize: 28.0,
                              ),
                            ),
                          Text("มั่นใจ ${(_outputs[0]["confidence"]*100).round()}%",style: TextStyle(color:Colors.purpleAccent,fontSize:18),)
                        ],
                      )
                      : Expanded(
                        child: Container(
